...
import numPic from "../../public/images/1.png";
        ...
        <div className="accordion-inner">
          {Array.from({ length: 10 }).map((_, idx) => {
            return (
              <div
                key={idx}
                className="movie-nav-card shadow-lg overflow-hidden"
                style={{
              ...
              >
                <Card className="d-flex flex-row rounded-0 border-0 bg-dark text-white movie-accordion-card">
                  <h4
